...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ne.vision.com.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ne.vision.com.security.DomainUserDetailsService", "createSpringSecurityUser");
